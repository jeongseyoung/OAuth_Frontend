...
const ID_CHECK_URL = () => `${API_DOMAIN}/auth/check-id`;
export const idCheckRequest = async (requestBody: IdCheckRequestDto) => {
  console.log(ID_CHECK_URL());
...
const EMAIL_CERTIFICATION_URL = () => `${API_DOMAIN}/auth/email-certi`;
export const emailCertificationRequest = async (
  requestBody: EmailCertificationRequestDto
) => {
  console.log(EMAIL_CERTIFICATION_URL);
  const result = await axios
...
export const SNS_SIGN_IN_URL = (type: "kakao" | "naver" | "google") =>
